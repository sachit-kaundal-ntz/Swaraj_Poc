    ...
    async def upload_image_to_gemini(self, image_path: str) -> Any:
        ...
        try:
            ...
            if not mime_type.startswith("image/"):
                uploaded_file = Part.from_data(mime_type= mime_type, data = data)
            else:
                uploaded_file = Part.from_data(mime_type=mime_type, data=data)
            logger.info("Succesfully uploaded image to gemini")
...
```json
{
  ...
  "overall_dimensions": {
    ...
    "other_critical_dimensions": [
      {"feature": "Hub Diameter", "value": "exact_value", "unit": "mm/inch", "tolerance": "if_shown", "location": "where_dimensioned"},
      {"feature": "Hub Length", "value": "exact_value", "unit": "mm/inch", "tolerance": "if_shown", "location": "where_dimensioned"},
      {"feature": "Bore Diameter", "value": "exact_value", "unit": "mm/inch", "tolerance": "if_shown", "location": "where_dimensioned"}
    ]
  },
  "feature_dimensions": [...],
  "tolerances": {...},
  ...
  "geometric_decomposition": {
    "base_shapes": [
      {
        "shape_type": "cylinder",
        "description": "main body/hub/etc",
        "dimensions": {"outer_diameter": "...", "height": "..."},
        "units": "mm/inch",
        "position": "axial/centered/etc",
        "additive_or_subtractive": "additive"
      },
      {
        "shape_type": "stepped_cylinder",
        "description": "gear blank with hub",
        "dimensions": {
          "main_outer_diameter": "...",
          "main_height": "...",
          "hub_outer_diameter": "...",
    ...
    "subtracted_features": [
      {
        ...
        "location": "coaxial with base cylinder",
